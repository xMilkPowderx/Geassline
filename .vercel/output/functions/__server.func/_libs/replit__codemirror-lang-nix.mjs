import { D as foldNodeProp, H as tags, S as delimitedIndent, T as foldInside, V as styleTags, a as completeFromList, c as snippetCompletion, d as LRLanguage, j as indentNodeProp, m as LanguageSupport, s as ifNotIn, y as continuedIndent } from "./@codemirror/autocomplete+[...].mjs";
import { i as LRParser, r as ExternalTokenizer } from "./@codemirror/lang-cpp+[...].mjs";
//#region node_modules/@replit/codemirror-lang-nix/dist/index.js
var strContent = 63;
...
var snippets = [/*@__PURE__*/ snippetCompletion("let ${binds} in ${expression}", {
	label: "let",
...
function nix() {
	return new LanguageSupport(nixLanguage, nixLanguage.data.of({ autocomplete: ifNotIn([
		"LineComment",
		"BlockComment",
		"String",
		"IndentedString"
