...
//#endregion
export { Direction as $, getIndentation as A, StateField as At, Tag as B, flatIndent as C, CharCategory as Ct, foldNodeProp as D, Prec as Dt, foldKeymap as E, Facet as Et, languageDataProp as F, combineConfig as Ft, NodeProp as G, tags as H, matchBrackets as I, countColumn as It, NodeWeakMap as J, NodeSet as K, sublanguageProp as L, findClusterBreak as Lt, indentOnInput as M, Transaction as Mt, indentString as N, codePointAt as Nt, foldService as O, RangeSetBuilder as Ot, indentUnit as P, codePointSize as Pt, Decoration as Q, syntaxHighlighting as R, fromCodePoint as Rt, delimitedIndent as S, ChangeSet as St, foldInside as T, EditorState as Tt, DefaultBufferLength as U, styleTags as V, IterMode as W, Tree as X, Parser as Y, parseMixed as Z, bracketMatching as _, showDialog as _t, completeFromList as a, drawSelection as at, defaultHighlightStyle as b, Annotation as bt, snippetCompletion as c, highlightActiveLine as ct, LRLanguage as d, hoverTooltip as dt, EditorView as et, Language as f, keymap as ft, StreamLanguage as g, runScopeHandlers as gt, ParseContext as h, rectangularSelection as ht, closeBracketsKeymap as i, crosshairCursor as it, indentNodeProp as j, Text as jt, getIndentUnit as k, StateEffect as kt, HighlightStyle as l, highlightActiveLineGutter as lt, LanguageSupport as m, placeholder as mt, autocompletion as n, WidgetType as nt, completionKeymap as o, dropCursor as ot, LanguageDescription as p, lineNumbers as pt, NodeType as q, closeBrackets as r, activateHover as rt, ifNotIn as s, getPanel as st, CompletionContext as t, ViewPlugin as tt, IndentContext as u, highlightSpecialChars as ut, bracketMatchingHandle as v, showPanel as vt, foldGutter as w, EditorSelection as wt, defineLanguageFacet as x, ChangeDesc as xt, continuedIndent as y, crelt as yt, syntaxTree as z };
